...
public class DemoApplication {
	...
	public static void main(String[] args) {
		User elke = new User("Elke", 44, "elke@ucll.be", "haloelke");
		...
		User miyo = new User("Miyo", 14, "miyo@ucll.be", "passwordMiyo55");
		System.out.println(miyo);

		User yuki = new User("Yuki", 12, "Yuki@ucll.be", "55Lol12");
		System.out.println("User with name " + yuki.getName() + " is " + yuki.getAge() + " years old");

		User eric = new User("Eric", 65, "eric@ucll.be", "SuperSecretPassword");
